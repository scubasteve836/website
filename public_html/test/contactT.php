...
if(_POST["submit"]) {
    $recipient="steve24244@gmail.com";
...
<p>Have Questions or want to reach out? Feel free to contact me about anything from questions to just getting in contact. You can either email me directly at steve@steveauman.com or fill on the form below.I'll try to get back to you as soon as possible. 
	<div class="row">
		<form role="form" id="contact-form" class="contact-form" method="POST" action="contactT.php">
                    <div class="row">
                		<div class="col-md-6">
